...
const {darkMode}=useContext(ThemeContext)
    ...
    return (
        <div className='flex justify-center items-center'>
            <div className={`w-[40vw] shadow-xl mt-20 ring-4 ring-black rounded-xl ${darkMode?"bg-black":"bg-white"}`}>
            <a href="/">
            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className="text-xl font-semibold tracking-tight text-purple-400">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-purple-400">$599</span>
                    <a
                        href="/"
